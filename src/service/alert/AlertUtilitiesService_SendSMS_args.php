...
class AlertUtilitiesService_SendSMS_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'AlertUtilitiesService_SendSMS_args';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('AlertUtilitiesService_SendSMS_args');
    if ($this->to !== null) {
      if (!is_array($this->to)) {
